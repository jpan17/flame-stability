...
def experts():
    ...
    plt.scatter(videos, joe, c = 'blue', marker = 'o')
#     plt.scatter(videos, debolina, c = 'gold', marker = 'o')
#     plt.scatter(videos, jess, c = 'crimson', marker = 'o')
#     plt.scatter(videos, dante, c = 'green', marker = 'o')
    axes = plt.gca()
    axes.set_xlim([0, 53])
    axes.set_ylim([-2, 4])
